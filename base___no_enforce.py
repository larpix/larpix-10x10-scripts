...
def main(controller_config=_default_controller_config, pacman_version=_default_pacman_version, logger=_default_logger, reset=_default_reset, modify_power=True, verbose=True, **kwargs):
    ...
    if modify_power:
        if pacman_version=='v1rev3':
            vddd = 40605
            vdda = 0
            set_pacman_power(c, vdda=vdda, vddd=vddd)
    ...
    if logger:
        ...
        if verbose: print('filename:',c.logger.filename)
